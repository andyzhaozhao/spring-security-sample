...
@Component
public class TaijiAccessDecisionManager implements AccessDecisionManager {
	...
	public void decide(Authentication authentication, Object obj,
		...
		if(obj instanceof FilterInvocation){
			String requsetUrl = ((FilterInvocation) obj).getRequestUrl();
			if(requsetUrl.equals("/") || requsetUrl.equals("/index")){
				//根路径页面都可以访问
				return ;
			}
		}
