 ...
 *
 */
public class TaijiFailureHandler implements AuthenticationFailureHandler {

    private static final Logger log = Logger.getLogger(TaijiFailureHandler.class);
    ...
    public TaijiFailureHandler() {
    }

    public TaijiFailureHandler(String defaultFailureUrl) {
